<template>
  <section class="container">
    ...
    <el-row>
      ...
      <el-col :span="1">
        <div>
          <el-avatar style="font-size:100px" :src="articleInfo.avatar"></el-avatar>
        </div>
      </el-col>
      <!-- 评论输入框 -->
      ...
      <el-col :span="1" style=" padding:100px 12px; ">
        <el-button type="success" plain size="small" @click="commentPush()">评论</el-button>
      </el-col>
    </el-row>
    ...
    <el-card shadow="hover" v-for="comment in articleInfo.comments" :key="comment.id" style="border-radius: 13px; width: 80%; margin: auto; margin-bottom:15px; min-height: 150px;">
      <el-row :gutter="20">
        ...
        <el-col :span="18">
          ...
          <div style="letter-spacing: 3px;font-size: 15px; line-height:1.5em; color: #666666">{{comment.content}}</div>
        </el-col>
      </el-row>
